...
void outb(unsigned char b, unsigned short addr);
void outw(unsigned short int b, unsigned short addr);
void outl(unsigned long b, unsigned short addr);
unsigned char inb(unsigned short addr);
unsigned short int inw(unsigned short addr);
unsigned long inl(unsigned short addr);
