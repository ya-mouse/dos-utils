...
#define iconv_init            NAMESPACE (iconv_init)
#define iconv_strerror        NAMESPACE (iconv_strerror)
#define IDNA_convert_to_ACE   NAMESPACE (IDNA_convert_to_ACE)
#define IDNA_convert_from_ACE NAMESPACE (IDNA_convert_from_ACE)
